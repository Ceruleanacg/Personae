...
spider_parser.add_argument("-c", "--codes", default=["600036", "601328", "601998", "601288"], nargs="+")
...
model_launcher_parser.add_argument("-c", "--codes", default=["600036, ""601328", "601998", "601288"], nargs="+")
